...
const Navbar = () => {
  ...
  return (
    <header
      className={
        currentTheme === 'dark'
          ? 'w-full mx-auto px-4 sm:px-20 fixed top-0 z-50 shadow bg-[#131313] dark:border-b dark:border-stone-600'
          : 'w-full mx-auto px-4 sm:px-20 fixed top-0 z-50 bg-white shadow dark:border-b dark:border-stone-600'
      }
    >
          ...
          <div className="flex items-center justify-between py-3">
            <Link to="home" className="cursor-pointer">
              <div className="md:py-5 md:block">
                <h2 className="text-2xl font-bold">Owoicho David Uji </h2>
              </div>
            </Link>
